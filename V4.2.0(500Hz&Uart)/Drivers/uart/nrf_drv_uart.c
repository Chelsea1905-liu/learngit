...
/****************************************************************************
*	函 数 名: 
*	功能说明: 增加串口1相关配置及发送接收函数
*	形    参：无
*	返 回 值: 无
*****************************************************************************/ 
void UART1_CONFIG(uint8_t rxd1_pin_number,uint8_t txd1_pin_number,uint32_t baud_rate)
{
	
	  nrf_gpio_cfg_output(txd1_pin_number); 
	  nrf_gpio_cfg_input(rxd1_pin_number,NRF_GPIO_PIN_NOPULL); 
